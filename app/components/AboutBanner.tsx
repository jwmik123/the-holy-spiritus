      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 mb-10 md:mb-0 md:pr-12">
            ...
            >
              Over onszelf <span className="block md:inline">en de kerk</span>
            </h1>
            ...
            <p ref={textRef} className="text-white text-lg opacity-90 max-w-xl">
              De ondernemers achter The Holy Spiritus zijn wij: Tom Genbrugge en
              Goderic Van den Brande. Beiden hebben meer dan een decennium
              ervaring met het produceren van dranken gemaakt van fruit en/of
              honing.
            </p>
          </div>
          ...
          <div ref={imageWrapperRef} className="w-full md:w-1/2 relative">
            <div className="relative h-[300px] md:h-[500px] rounded-lg overflow-hidden shadow-xl transform md:rotate-1 border-4 border-white">
              <Image
                src="/images/eigenaren.webp"
                alt="Tom Genbrugge en Goderic Van den Brande"
                fill
